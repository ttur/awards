    ...
    t.textutils = {
        ...
        getUsedFontsFromWidgetsModels: function(e) {
            for (var i = {}, s = {}, n = {}, a = {}, o = e.models, r = 0; r < o.length; r++) {
                ...
                "text" == w(l, "type") && w(l, "text") && _.extend(i, this.scanTextForFontsAndVariationsRaw(w(l, "text"), w(l, "version"), e.excludeUnusedDefault)), 
        ...
        scanTextForFontsAndVariationsRaw: function(e, i, s) {
            ...
            var y, b = (l = w(a, null)).fontFamily + "|" + l.fontStyle + "|" + l.fontWeight;
            m[b] = 1;
            var k = !1, x = function(t) {
                return -1 !== _.findIndex(t.childNodes, function(t) {
                    return t.nodeType === Node.TEXT_NODE && t.textContent.replace(/\r?\n/g, "").length;
                });
            }, P = _.filter(c, x);
            for (r = 0; r < P.length; r++) y = (l = w(P[r], null)).fontFamily + "|" + l.fontStyle + "|" + l.fontWeight, 
            k = k || y === b, m[l.fontFamily + "|" + l.fontStyle + "|" + l.fontWeight] = 1;
            var T = x(a);
            for (!s || k || T || delete m[b], n = 0; n < v.length; n++) if ("default" != (p = v[n])) {
