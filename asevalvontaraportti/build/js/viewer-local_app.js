    ...
    t.classes.extendAnalyticsPublic = {
        ...
        sendEvent: function(e, i, s, n) {
            if (window.ga) {
                ...
                r.dimension6 = this._rmdata.first_medium, this._rmdata = null), window.ga("readymag.send", r)), t.common.userTracker && "Project Actions" == o.category && window.ga("t0.send", r), 
                r;
            }
        },
        trackPage: function(e) {
            if (window.ga) {
                ...
                if (void 0 != this.shortlink_redirect && (i = _.extend(i, this._processRedirectUTM())), i.page != this.lastTrackedUrl) {
                    ...
                    s.dimension6 = this._rmdata.first_medium, this._rmdata = null), window.ga("readymag.send", "pageview", s)), 
        ...
        _saveFirstInteraction: function() {
            if (!(t.utils.getCookie("_rmdata") || Modernizr.localstorage && window.localStorage && window.localStorage.getItem("_rmdata"))) {
                var e = document.referrer || "direct", i = window.location.href, s = t.utils.queryUrlGetParam("utm_campaign"), n = t.utils.queryUrlGetParam("utm_source"), a = t.utils.queryUrlGetParam("utm_medium"), o = {
                    dimension: [ s, n, a, e, i ].join("|"),
                    first_medium: a,
                    first_campaign: s,
                    first_source: n,
                    rm_url: i,
                ...
                this._rmdata = o, t.utils.createCookie("_rmdata", r), Modernizr.localstorage && window.localStorage && window.localStorage.setItem("_rmdata", r);
            }
        },
